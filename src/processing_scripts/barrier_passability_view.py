...
def build_views(conn):
    ...
    for i in range(len(specCodes)):
        ...
        b.total_upstr_hab_spawn_{code} * (1 - p{i}.passability_status::double precision) as discon_total_upstr_hab_spawn_{code},
        b.func_upstr_hab_spawn_{code} * (p{i}.passability_status::double precision) as con_func_upstr_hab_spawn_{code},
        b.total_upstr_hab_spawn_{code} * (p{i}.passability_status::double precision) as con_total_upstr_hab_spawn_{code},
        b.func_upstr_hab_rear_{code},
        b.total_upstr_hab_rear_{code},
        b.func_upstr_hab_rear_{code} * (1 - p{i}.passability_status::double precision) as discon_func_upstr_hab_rear_{code},
        b.total_upstr_hab_rear_{code} * (1 - p{i}.passability_status::double precision) as discon_total_upstr_hab_rear_{code},
        b.func_upstr_hab_rear_{code} * (p{i}.passability_status::double precision) as con_func_upstr_hab_rear_{code},
        b.total_upstr_hab_rear_{code} * (p{i}.passability_status::double precision) as con_total_upstr_hab_rear_{code},
